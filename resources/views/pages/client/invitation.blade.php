...
<main class="min-h-screen w-full flex items-center justify-center">
    <div class="p-8 md:w-1/3 mx-auto md:shadow-[0_0_10px_rgba(0,0,0,0.25)] md:rounded-2xl">
        <h1 class="text-[2rem] mb-8">Activer mon compte</h1>
        <form action="{{ route('invitation.store') }}" method="post" class="flex flex-col gap-4">
            @csrf
            ...
            <x-global.link-button.button title="Activer mon compte">Activer mon compte</x-global.link-button.button>
        </form>
    </div>
</main>
</body>
