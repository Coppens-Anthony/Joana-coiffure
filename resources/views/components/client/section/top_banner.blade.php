<section
    ...
    <div class="text-center mx-8 md:mx-16 flex flex-col gap-16 items-center" itemtype="https://schema.org/Organization" itemscope>
        ...
        <p class="text-xl md:text-[2rem] text-white" itemprop="keywords">Des prestations personnalisées, un savoir-faire professionnel et une attention particulière portée à chaque détail.</p>
